...
The registered project-lead task remains the overseer across stages. On 2026-09-20 the user authorized **Main Lead 3.0**, task `01a0c0c1-3952-7720-93c8-ff49192b8e13`, as the persistent lead; follow [the current transfer record](docs/handoffs/main-lead-3.0.md). Main Lead 2.0 (`01a0bb80-cf0d-7f60-8e46-1e825f42d276`) and the original lead (`01a0b845-6c8d-7021-a5c9-15e673db07c9`) are reference-only. Workers report **READY FOR PROJECT-LEAD REVIEW — Stage N**, with exact SHA/PR, evidence/gaps and a draft next prompt. The lead owns global status, acceptance/merge coordination and the final **START A NEW IMPLEMENTATION CHAT** prompt. Follow `docs/PROJECT_OVERSIGHT.md` and `docs/CHAT_STAGES.md`; do not rotate project ownership without explicit user authorization or let workers declare global completion. Use isolated worker worktrees, never switch another worker's checkout, and keep previous worker chats for assigned fixes.
