...
- **Current scope:** [questionnaire priorities](docs/QUESTIONNAIRE_PRIORITIES.md), [all 111 rows and gaps](docs/QUESTIONNAIRE_ROW_MAP.md), and [scope changes](docs/QUESTIONNAIRE_SCOPE_DELTA.md). Focused current-candidate accounting: **32 Demonstrated / 22 Partial / 9 Documentary / 48 Missing = 111**. Historical 65/67/68 planning bundles and the 51 candidate evidence IDs are not fully satisfied-row counts. Retain the separate [customer phase gaps](docs/PHASE_COVERAGE.md).
