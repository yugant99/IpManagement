...
**Main Lead 6.0 takeover — 2026-09-23:** GPT-6 Astra task `01a0cf70-c4e0-7ed2-b50b-834609e6d909` is the user-authorized persistent lead, superseding Main Lead 5.0 for new coordination. Identity was confirmed from `CODEX_THREAD_ID` and the app task registry. The user resumed T024 from PR97 amendment `ddc644aabeda40e85d416b6a27b4652f2a7d543e`; the earlier sleep hold is lifted. [Current transfer](handoffs/main-lead-6.0.md). T024 keeps its complete nine-path lease and settled contracts; fresh route preflight precedes dispatch. Sol independently reviews source/shared invariants and T027; separate Luna verifies prerequisite-complete T025 on disposable synthetic data. DeepSeek is the recorded fallback, preserving the complete Spark feature. Opus remains unavailable with no timed retry. T025 is unrun; T028 remains the next bridge-to-main merge. No source-only main merge, private training inputs, deployment, customer access, questionnaire promotion or Tier B release. Earlier dated authority/dispatch entries below are history.
