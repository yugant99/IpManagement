...
| Stage 4 scheduler/integration | Proposed `codex/stage-4-scheduler-integration`, exact base #18 publication `63287e0ff281b678abbd8809ca9160739de8c537`, approved exact #19 source dependency above | [Kickoff approved](handoffs/stage-04-kickoff.md); task not yet created/registered. Do not infer a worker exists |
...
- Stage 4: scheduler/feed adapter/status UI, minimal app/store/schema/common UI integration and wheel package inclusion; source integration/freeze record. Coordinate new schema policy with core. Follow the exact [kickoff](handoffs/stage-04-kickoff.md).
