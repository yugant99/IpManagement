...
| Stage 4 scheduler/integration, `01a0bacd-a541-73e1-8a06-f674dd4a1bcd` | `codex/stage-4-scheduler-integration`, isolated `Ip_inventory-stage-4`; published intermediate schema/store/package checkpoint `16160806e91023a29eae501b824c6b43e5e56d87` after dependency integration `ef4158536f437710677440eb973a5fe242be9962` | Active under [approved kickoff](handoffs/stage-04-kickoff.md); scheduler/lifecycle/UI integration still in progress. Intermediate schema contract conditionally aligned with state operations; no complete Stage 4 acceptance |
