...
Status: **current bounded adjudication on 2026-09-21.** The controlling [111-row evidence table](QUESTIONNAIRE_ROW_MAP.md) records **39 Demonstrated / 18 Partial / 10 Documentary / 44 Missing**. The [portable checkpoint](handoffs/vm-portability-lead-review.md) adds bounded deployment (090 Demonstrated), prepared-host recovery (020 Partial) and Mac-to-Linux transfer (023 Partial). The [easy-win follow-up](handoffs/easy-wins-lead-review.md) adds bounded credit for RFP-005/006/026/035/043/077 while retaining prior verified requester-subnet UI, bounded local correction/reconciliation, exercised escalation, and substantive user/operator guidance for RFP-092; RFP-104 remains Missing. PR #44 and the native procedural handoff are accepted within their documented limits. These classes are not a percentage of fully satisfied customer requirements. Use [status](STATUS.md) and the separate [DOCX phase gaps](PHASE_COVERAGE.md) for current acceptance. The original 30 goals and planning bundles below remain work references, not achievement totals.
...
- **014–017/019:** the single-instance app does not supply HA, failover, geographical DR or a measured backup-loss policy. **020** now has a 4.427-second prepared-host restore/readiness observation, but full outage-to-business recovery remains unproved. A bigger VM does not remove those gaps.
