...
**T025 progress:** Current frozen candidate **`8eb3e231b7792fe8415455d2176e962b8f953d60`** includes independently reviewed original-author fixes for the UI import, curl config and coordinator read/write lifetime (PR101/102/103). The earlier acquisition timeout/STORE_BUSY store and unknown key remain preserved. Visible Luna is performing affected acquisition/global-run reruns plus all remaining required workflow/recovery/business comparisons. Full locked UI build, protected readiness and bounded migration observations have recorded positive evidence, with candidate continuity explicit; full T025 remains unpassed. Main unchanged; exact owners/branches are in first-wave.json.
