...
**T025 progress:** Current frozen candidate is **`0c20a7ba82c9802d20223d164efdc830e9ab1eac`**, including source-reviewed T010 type-import correction220c4a2/PR101 and Spark curl-option correctionf8d381a/PR102. Candidate2 full locked UI build passed; its unchanged frontend assets are explicitly pinned for candidate3. Visible Luna is executing the remaining required observations; complete T025 remains unpassed. Earlier failed builds/wrapper observations are retained. Main stays unchanged. Verifier source/evidence worktrees and local artifacts are recorded in first-wave.json.
