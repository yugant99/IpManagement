...
Immediate scenario changes may show route withdrawal, intentional incomplete evidence, complete restoration and current occupancy growth/relief. Historical p95, completed-day forecast and 30-day conflicts need not change immediately. The reviewed producer recipe explicitly declares an intentional partial step through coverage completeness; it yields visible partial/unknown results. Unexpected rejected records or malformed bundles fail the cycle. Expected answers remain outside runtime inputs. The adapter pins the original nine baseline assets, rather than trusting matching envelope headers alone. The reviewed v1 producer stops visibly after cycle 1460 (365 simulated days); it never rewinds the cursor.
