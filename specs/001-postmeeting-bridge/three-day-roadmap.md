...
|---|---|---|---|
| 1 | T001–T007 foundation: Terra schema then trusted context/all-egress integration; UI T006 after frozen auth contract. Grok scout T002/T019 and optional authorized Fable T027 design advice alongside core. Start T008 comparison only after access source gate. | T020: 2h integration inventory/matrix across every integration row; detail selected local contracts, flag unknown vendor facts. | G-D1: authority/schema/access contract and full route inventory accepted, no unresolved bypass/design leak, Day1 matrix reviewable. If not, stop optional work and reforecast; do not mock away trusted access. |
